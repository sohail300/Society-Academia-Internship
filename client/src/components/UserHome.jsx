    ...
    <>
      ...
      <div className='component-box' style={{ display: "flex", justifyContent: "space-evenly", alignItems: "center", margin: "40px 0px" }}>
        <div>
          ...
          <div className='home-btn' style={{ ...homeBtnStyle, backgroundColor: "#92DAFF" }} onClick={() => navigate('/uploadmap')}  >
            <h3 style={{ marginLeft: "4vh", textAlign: "left", margin: "auto 2vw", fontSize: "1.5rem" }}>UPLOAD MAP</h3>
            <img src={Arrow} alt="" />
          </div>
